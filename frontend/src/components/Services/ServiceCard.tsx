          ...
          <div className="bg-green-50 h-full flex  w-full max-w-[1500px] flex-wrap reverse rounded-l-md">
            ...
            <div className="m-h-full  grow bg-moksha-blue-mutant pl-24 pt-10 pb-20" >
              ...
              <div className="max-w-[556px]">
                <span className="text-white">
                  Elevate your geospatial strategies with Moksha's Consulting and Advisory Services. Our seasoned professionals serve as strategic partners throughout your project lifecycle. From initial ideation to seamless execution, we provide valuable insights and guidance, helping you navigate the complexities of geomatics, land use planning, and digital solutions. Trust us to be your compass in the ever-evolving landscape of spatial technologies.
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="w-full flex justify-center h-full rounded-l-md mb-24">
          <div className="bg-green-50 h-full flex  w-full max-w-[1500px] flex-wrap reverse rounded-l-md">
            ...
            <div className="m-h-full  grow bg-moksha-blue-mutant pl-24 pt-10 pb-20" >
              ...
              <div className="max-w-[556px]">
                <span className="text-white">
                  Embark on a journey of precision and efficiency with our state-of-the-art Land Surveying services. Moksha Enterprises employs cutting-edge technology and a skilled team to capture accurate and reliable data. Whether it's topographic surveys, boundary delineation, or construction layout, our surveys set the foundation for informed decision-making in any geospatial project.
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-green-50 h-full flex  w-full max-w-[1500px] flex-wrap flex-row-reverse rounded-l-md">
            ...
            <div className="m-h-full  grow bg-moksha-blue-mutant pl-24 pt-10 pb-20" >
              ...
              <div className="max-w-[565px]">
                <div className="text-white">
                  <div className="mb-2">
                    Navigate the future with confidence using our cutting-edge Geographic Information System (GIS) Mapping and Analysis solutions. We go beyond mere mapping, offering in-depth analysis to derive actionable insights. Our tailored GIS solutions empower you to make informed decisions, manage resources effectively, and visualize spatial data for a holistic understanding of your environment.
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="w-full flex justify-center h-full rounded-l-md mb-24">
          <div className="bg-green-50 h-full flex  w-full max-w-[1500px] flex-wrap reverse rounded-l-md">
            ...
            <div className="m-h-full  grow bg-moksha-blue-mutant pl-24 pt-10 pb-20" >
              ...
              <div className="max-w-[556px]">
                <span className="text-white">
                  Venture into the digital realm with Moksha's Web App Development services. Our team crafts bespoke, user-friendly applications tailored to meet your unique needs. Whether it's enhancing your digital presence, streamlining operations, or creating interactive mapping tools, our web apps are designed to elevate your user experience and operational efficiency in the ever-evolving digital landscape.
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-green-50 h-full flex  w-full max-w-[1500px] flex-wrap flex-row-reverse rounded-l-md">
            ...
            <div className="m-h-full  grow bg-moksha-blue-mutant pl-24 pt-10 pb-20" >
              ...
              <div className="max-w-[565px]">
                <div className="text-white">
                  <div className="mb-2">
                    Unlock cost-effective solutions with Moksha's Packaged Equipment Rental services. When you need specialized geomatics equipment or technology for short-term projects, our diverse rental options ensure you have access to the tools you need without the long-term commitment. From high-precision surveying instruments to cutting-edge mapping devices, our rental services are designed to support your project needs without compromising on quality.
                  </div>
                </div>
              </div>
            </div>
