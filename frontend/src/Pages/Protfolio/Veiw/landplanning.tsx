    ...
    <div className='text -blue mt-20'>
      <div className='flex w-full gap-20 bg-white flex-wrap'>
        <div className='grow flex justify-center items-center' >
          <div className='flex flex-col gap-6 p-2'>
            ...
            <div className='text-moksha-black text-2xl font-semibold leading-7'>
              Land Use Planning for Gurbhakot Municipality
            </div>
            <div>
              <span className='text-sm'>
                In orchestrating the land use planning for Gurbhakot Municipality, Moksha Enterprises<br />
                seamlessly integrated precision mapping, community engagement, and sustainable<br />
                development strategies, leveraging advanced technology and GIS- driven decision<br /> - making for a transparent, future- ready, and implementable plan..
              </span>
            </div>
        ...
        <div className='grow flex justify-center max-w-[656px] max-h-[404px] h-full w-full'>
          <div>
            <img src='/assets/reports/land_planning.png' className='max-w-[656px] max-h-[404px]' />
          </div>
        </div>
